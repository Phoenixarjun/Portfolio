...
import EAndESection from "../layouts/ModernHomePage/EAndESection"; // Import the wrapper component

const ModernHomePage = ({ toggleOpen, handleToggle }) => {
  return (
    <div className="min-h-screen">
      <Navbar isToggle={true} toggleOpen={toggleOpen} handleToggle={handleToggle} />
      <div className="flex flex-col items-center justify-center min-h-[calc(100vh-80px)] relative z-20">
